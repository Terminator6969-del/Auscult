...
export const TESTS: Test[] = [
  ...
  { id: 'hiv-rapid',   name: 'Rapid HIV Ag/Ab (point-of-care)', category: 'lab', turnaroundSec: 20 },
  { id: 'gene-xpert',  name: 'GeneXpert MTB/RIF (sputum)', category: 'lab', turnaroundSec: 120 },
  { id: 'fingerprick-glucose', name: 'Fingerstick Glucose (bedside)', category: 'bedside', turnaroundSec: 10 },
  { id: 'urine-dipstick', name: 'Urine Dipstick',        category: 'bedside', turnaroundSec: 10 },
